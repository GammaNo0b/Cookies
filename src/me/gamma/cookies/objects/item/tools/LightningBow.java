...
public class LightningBow extends AbstractCustomItem {
	...
	private static final ByteProperty IS_LIGHTNING_PROJECTILE = new ByteProperty("islightningprojectile");
	...
	public Listener getCustomListener() {
		return new Listener() {
			...
			public void onBowShoot(EntityShootBowEvent event) {
				if(event.getBow().getItemMeta().hasLocalizedName() && event.getBow().getItemMeta().getLocalizedName().equals(getRegistryName())) {
