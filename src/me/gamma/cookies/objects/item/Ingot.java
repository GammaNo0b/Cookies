...
public class Ingot extends AbstractCustomItem {
	...
	public Ingot(String identifier, String name, Material material) {
		this(identifier, name, material, -1);
	}


	public Ingot(String identifier, String name, Material material, int customModelData) {
