...
public abstract class AbstractStorageSkullBlock extends AbstractGuiProvidingSkullBlock implements StorageProvider {
	...
	public int getCapacity() {
		return MathHelper.intpow(4, this.getTier() - 1);
	}
	...
	public Recipe getRecipe() {
		...
		recipe.setIngredient('I', this.getMaterialIngredient());
		recipe.setIngredient('M', this.getMiddleIngredient());
		recipe.setIngredient('C', this.getCenterIngredient());
		recipe.setIngredient('S', this.getPreviousTierStorageIngredient());
		return recipe;
	}


	public abstract ItemStack getMaterialIngredient();

	public abstract ItemStack getMiddleIngredient();

	public abstract ItemStack getCenterIngredient();

	public abstract ItemStack getPreviousTierStorageIngredient();
