...
public class ClownfishStorageSkullBlock extends AbstractStorageSkullBlock {

	@Override
	public String getBlockTexture() {
		return HeadTextures.BLUE_STORAGE_CRATE;
	}


	@Override
	public String getDisplayName() {
		return "§6C§fl§6o§fw§6n§ff§6i§fs§6h §9Storage §dBlock";
	}
	...
	public ItemStack getCenterIngredient() {
		return new ItemBuilder(Material.TROPICAL_FISH).setName("Clownfish").build();
	}


	@Override
	public ItemStack getPreviousTierStorageIngredient() {
		return CustomBlockSetup.STORAGE_BLOCK_TIER_4.createDefaultItemStack();
	}
