...
import me.gamma.cookies.object.tile.machine.Compressor;



public class CompressorBlock extends AbstractCraftingMachineBlock<CompressorBlock, Compressor> {

	public CompressorBlock(MachineTier tier) {
		super(tier);
	}
	...
	@Override
	public CompressorBlock castCustomBlock() {
		return this;
	}


	@Override
	public Compressor createNewTileEntity(Block block) {
		return new Compressor(this, block);
	}
