...
import me.gamma.cookies.object.tile.machine.Crusher;



public class CrusherBlock extends AbstractCraftingMachineBlock<CrusherBlock, Crusher> {
	...
	@Override
	public CrusherBlock castCustomBlock() {
		return this;
	}


	@Override
	public Crusher createNewTileEntity(Block block) {
		return new Crusher(this, block);
	}
