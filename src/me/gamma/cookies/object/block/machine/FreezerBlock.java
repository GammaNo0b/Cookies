...
import me.gamma.cookies.object.tile.machine.Freezer;
import me.gamma.cookies.util.ItemBuilder;



public class FreezerBlock extends AbstractCraftingMachineBlock<FreezerBlock, Freezer> {

	public FreezerBlock(MachineTier tier) {
		super(tier);
	}
	...
	@Override
	public FreezerBlock castCustomBlock() {
		return this;
	}


	@Override
	public Freezer createNewTileEntity(Block block) {
		return new Freezer(this, block);
	}
