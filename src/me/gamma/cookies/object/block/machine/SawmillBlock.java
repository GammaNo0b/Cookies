...
import me.gamma.cookies.object.tile.machine.Sawmill;



public class SawmillBlock extends AbstractCraftingMachineBlock<SawmillBlock, Sawmill> {

	public SawmillBlock(MachineTier tier) {
		super(tier);
	}
	...
	@Override
	public SawmillBlock castCustomBlock() {
		return this;
	}


	@Override
	public Sawmill createNewTileEntity(Block block) {
		return new Sawmill(this, block);
	}
