...
import me.gamma.cookies.object.tile.machine.DyePress;



public class DyePressBlock extends AbstractCraftingMachineBlock<DyePressBlock, DyePress> {

	public DyePressBlock() {
	...
	public List<MachineRecipe> getAllMachineRecipes() {
		...
		recipes.add(new RandomOutputsRecipe(this, "open_eyeblossom", new ItemStack(Material.OPEN_EYEBLOSSOM), 80).addOutput(Material.ORANGE_DYE, 1.0, 1, 2).addOutput(Material.WHITE_DYE, 0.25, 1, 1).addOutput(Material.GRAY_DYE, 0.25, 1, 1).addOutput(Material.BLACK_DYE, 0.125, 1, 1).addOutput(Material.GLOWSTONE_DUST, 0.125, 1, 1));
		recipes.add(new RandomOutputsRecipe(this, "open_eyeblossom", new ItemStack(Material.CLOSED_EYEBLOSSOM), 80).addOutput(Material.ORANGE_DYE, 1.0, 1, 2).addOutput(Material.LIGHT_GRAY_DYE, 0.25, 1, 1).addOutput(Material.GRAY_DYE, 0.25, 1, 1).addOutput(Material.BLACK_DYE, 0.125, 1, 1));
	...
	@Override
	public DyePressBlock castCustomBlock() {
		return this;
	}


	@Override
	public DyePress createNewTileEntity(Block block) {
		return new DyePress(this, block);
	}
