...
import me.gamma.cookies.object.tile.machine.AbstractGuiMachine;



public abstract class AbstractGuiMachineBlock<B extends AbstractGuiMachineBlock<B, T>, T extends AbstractGuiMachine<T, B>> extends AbstractMachineBlock<B, T> implements UpdatingGuiProvider {

	public AbstractGuiMachineBlock(MachineTier tier) {
		super(tier);
	}
