...
import me.gamma.cookies.object.tile.machine.Smeltery;
import me.gamma.cookies.util.ItemBuilder;



public class SmelteryBlock extends AbstractCraftingMachineBlock<SmelteryBlock, Smeltery> {

	public SmelteryBlock(MachineTier tier) {
		super(tier);
	}
	...
	@Override
	public SmelteryBlock castCustomBlock() {
		return this;
	}


	@Override
	public Smeltery createNewTileEntity(Block block) {
		return new Smeltery(this, block);
	}
