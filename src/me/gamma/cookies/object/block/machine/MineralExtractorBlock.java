...
import me.gamma.cookies.object.tile.machine.MineralExtractor;



public class MineralExtractorBlock extends AbstractCraftingMachineBlock<MineralExtractorBlock, MineralExtractor> {

	public MineralExtractorBlock(MachineTier tier) {
		super(tier);
	}
	...
	@Override
	public MineralExtractorBlock castCustomBlock() {
		return this;
	}


	@Override
	public MineralExtractor createNewTileEntity(Block block) {
		return new MineralExtractor(this, block);
	}
