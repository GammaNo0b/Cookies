...
public class PlayerArmorEquipEventListener implements Listener {
	...
	public void inventoryClickEvent(InventoryClickEvent event) {
		...
		if(shift) {
			if(type != null) {
				...
				if(equipping == isAirOrNull(type.getArmor(player.getInventory()))) {
	...
	public void playerInteractEvent(PlayerInteractEvent event) {
		if(event.getAction() == Action.RIGHT_CLICK_AIR || event.getAction() == Action.RIGHT_CLICK_BLOCK) {
			...
			if(type != null && isAirOrNull(type.getArmor(event.getPlayer().getInventory()))) {
	...
	public void dispenseArmorEvent(BlockDispenseArmorEvent event) {
		...
		if(type != null && event.getTargetEntity() instanceof Player && isAirOrNull(type.getArmor(((Player) event.getTargetEntity()).getInventory()))) {
	...
	private static boolean isAirOrNull(ItemStack stack) {
